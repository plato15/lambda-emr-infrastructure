pipeline {
    ...
    stages {
        stage('Submit Stack') {
            steps {
            sh "aws s3 cp file://s3_uploads/lambda_codes_uploads/lambda-spin-emr.zip s3://saidatech-datalake-coderepo-test/lambda-codes/lambda-spin-emr.zip/lambda-spin-emr.zip"
